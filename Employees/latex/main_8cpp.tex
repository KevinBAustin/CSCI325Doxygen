...
the main file for the \mbox{\hyperlink{classEmployee}{Employee}} project  
...
\end{DoxyAuthor}
\begin{DoxyDate}{Date}
2023-\/11-\/17 Runs the employee project and uses classes employee, supervisor, and officer 
\end{DoxyDate}
