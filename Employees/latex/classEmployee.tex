...
\mbox{\hyperlink{classEmployee}{Employee}} class constuctor
...
Another \mbox{\hyperlink{classEmployee}{Employee}} class instructor that is used when given variables are used
...
\hline
{\em double} & hourly\+Rate employee hourlyrate \\
\hline
